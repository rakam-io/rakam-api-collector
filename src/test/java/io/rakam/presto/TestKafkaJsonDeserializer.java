        ...
        extends TestDeserializer<ConsumerRecord<byte[], byte[]>>
{
            ...
            throws IOException
    {
        ...
        Block block = testcollection.page.getBlock(24);
            ...
            throws IOException
    {
        ...
        Map<String, TableData> testproject = pageTable.row("testproject");
        TableData testcollection = testproject.get("testcollection");
        assertEquals(testcollection.metadata.size(), 3);
        assertEquals(testcollection.page.getChannelCount(), 3);
        assertEquals(testcollection.page.getPositionCount(), 1);

        Block block = testcollection.page.getBlock(2);

        BlockAssertions.assertBlockEquals(COLUMNS.get(0).getType(), block,
            ...
            throws IOException
    {
        ...
        BlockAssertions.assertBlockEquals(COLUMNS.get(0).getType(), block, getBlock(FIELDS.get(0)));
    }
            ...
            throws IOException
    {
        ...
        block = testcollection.page.getBlock(25);
